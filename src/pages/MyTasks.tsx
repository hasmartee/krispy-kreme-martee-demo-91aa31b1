...
export default function MyTasks() {
  ...
  const [tasks, setTasks] = useState<Task[]>([
    ...
    {
      id: "2",
      title: "Put Out Morning Products",
      description: "Set up morning product displays (pastries, hot breakfast items)",
      time: "Morning",
      icon: Star,
      path: "/store-products",
      completed: false,
    ...
    {
      id: "4",
      title: "Rotate to Lunch Products",
      description: "Remove morning items and put out lunch products (sandwiches, wraps, salads)",
      time: "Midday",
      icon: ArrowRight,
      path: "/store-products",
      completed: false,
    ...
    {
      id: "5",
      title: "Check Afternoon Stock",
      description: "Rotate and check afternoon products for freshness",
      time: "Afternoon",
      icon: CheckSquare,
      path: "/store-products",
      completed: false,
