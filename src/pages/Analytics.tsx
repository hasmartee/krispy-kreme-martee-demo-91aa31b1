  ...
  return (
    <div className="flex-1 space-y-6 p-6">
      ...
      <div className="space-y-6 mt-12 pt-12 border-t">
        <div>
          <h2 className="text-2xl font-bold text-foreground">Inventory Insights</h2>
          <p className="text-muted-foreground">
            Track ingredient usage and optimize inventory management
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <Card className="shadow-card">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-foreground">
                {isSingleStoreView ? "94.2%" : "96.8%"}
              </div>
              <p className="text-xs text-muted-foreground">
                vs expected based on recipes
              </p>
          ...
          <Card className="shadow-card">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-foreground">
                {isSingleStoreView ? "2" : "8"}
              </div>
              <p className="text-xs text-muted-foreground">
                ingredients over optimal level
              </p>
              <div className="mt-2 flex items-center gap-2">
          ...
          <Card className="shadow-card">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Waste vs Recipe</CardTitle>
              <CheckCircle className="h-4 w-4 text-muted-foreground" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-foreground">
                {isSingleStoreView ? "+2.4%" : "+3.1%"}
              </div>
              <p className="text-xs text-muted-foreground">
                actual waste vs expected
              </p>
              <div className="mt-2 flex items-center gap-2">
        ...
        <Card className="shadow-card">
          <CardHeader>
            <CardTitle>Ingredient Usage vs Expected</CardTitle>
            <CardDescription>
              Top ingredients by volume with usage variance
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Table>
              ...
              <TableBody>
                <TableRow>
                  ...
                  <TableCell className="text-right">{isSingleStoreView ? "45.2" : "1,108"}</TableCell>
                  <TableCell className="text-right">{isSingleStoreView ? "43.8" : "1,072"}</TableCell>
                  <TableCell className="text-right text-success">-3.1%</TableCell>
                  <TableCell className="text-right">
                    <Badge variant="outline" className="bg-success/10 text-success border-success/20">Efficient</Badge>
                  </TableCell>
                </TableRow>
                <TableRow>
                  <TableCell className="font-medium">Lettuce</TableCell>
                  <TableCell>Vegetables</TableCell>
                  <TableCell className="text-right">{isSingleStoreView ? "28.5" : "698"}</TableCell>
                  <TableCell className="text-right">{isSingleStoreView ? "29.2" : "715"}</TableCell>
                  <TableCell className="text-right text-destructive">+2.5%</TableCell>
                  <TableCell className="text-right">
                    <Badge variant="outline" className="bg-warning/10 text-warning border-warning/20">Monitor</Badge>
                  </TableCell>
                </TableRow>
                <TableRow>
                  <TableCell className="font-medium">Avocado</TableCell>
                  <TableCell>Vegetables</TableCell>
                  <TableCell className="text-right">{isSingleStoreView ? "32.0" : "784"}</TableCell>
                  <TableCell className="text-right">{isSingleStoreView ? "31.8" : "779"}</TableCell>
                  <TableCell className="text-right text-success">-0.6%</TableCell>
                  <TableCell className="text-right">
                    <Badge variant="outline" className="bg-success/10 text-success border-success/20">On Target</Badge>
                  </TableCell>
                </TableRow>
                <TableRow>
                  <TableCell className="font-medium">Tomatoes</TableCell>
                  <TableCell>Vegetables</TableCell>
                  <TableCell className="text-right">{isSingleStoreView ? "24.8" : "608"}</TableCell>
                  <TableCell className="text-right">{isSingleStoreView ? "26.4" : "647"}</TableCell>
                  <TableCell className="text-right text-destructive">+6.5%</TableCell>
                  <TableCell className="text-right">
                    <Badge variant="outline" className="bg-destructive/10 text-destructive border-destructive/20">Review</Badge>
                  </TableCell>
                </TableRow>
                <TableRow>
                  <TableCell className="font-medium">Bread</TableCell>
                  <TableCell>Bakery</TableCell>
                  <TableCell className="text-right">{isSingleStoreView ? "52.0" : "1,274"}</TableCell>
                  <TableCell className="text-right">{isSingleStoreView ? "51.2" : "1,254"}</TableCell>
                  <TableCell className="text-right text-success">-1.5%</TableCell>
                  <TableCell className="text-right">
                    <Badge variant="outline" className="bg-success/10 text-success border-success/20">Efficient</Badge>
                  </TableCell>
                </TableRow>
